...
# Группа URL-адресов для работы с постами и комментариями ---4
posts_urls = [
...
# Группа URL-адресов для работы с профилями пользователей ---5
profile_urls = [
...
# Основной список URL-адресов приложения blog ---4
urlpatterns = [
    ...
    path('posts/', include(posts_urls)), #---4
